...
![](lecture_15_walkthrough_files/figure-markdown_github/unnamed-chunk-8-1.png)
...
![](lecture_15_walkthrough_files/figure-markdown_github/unnamed-chunk-9-1.png)
...
```
    ...
    ## Info: Working in directory /Users/pepershaker1221/Desktop/BGGN213/BGGN213_LQ_Repository/lecture_15_git
...
``` r
sig_genes_table <- write.table(sig_genes, file="significant_genes.txt", row.names=FALSE, col.names=FALSE, quote=FALSE)
```
